...
import { removeTodolist, todolistsActions } from "features/TodolistsList/todolistsSlice";
...
//   type Action = TestAction<typeof todolistsActions.fetchTodolists.fulfilled>;
//   const action: Action = {
